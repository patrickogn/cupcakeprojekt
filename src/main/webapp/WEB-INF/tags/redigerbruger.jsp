...
<t:pagetemplate>
    ...
    <jsp:body>
        <form method="post" action="OpdaterBrugerServlet">
            ...
            <input type="text" id="kodeord" readonly name="kodeord" value="${requestScope.user.password}"/><br/>

            <label for="roleid">Role ID:</label>
            <input type="text" id="roleid" readonly name="roleid" value="${requestScope.user.role_id}"/><br/>
